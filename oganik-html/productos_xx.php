...
<head>
    ...
    <title>Productos || Techic SA </title>
    <!-- favicons Icons -->
                ...
                <div class="container">
                    ...
                    <div class="topbar__left">
                        ...
                        <div class="topbar__info">
                            ...
                            <p>Email <a href="mailto:contacto@techic.com.bo">contacto@techic.com.bo</a></p>
                        </div><!-- /.topbar__info -->
                    </div><!-- /.topbar__left -->
                    <div class="topbar__right">
                        <div class="topbar__info">
                            <i class="organik-icon-calling"></i>
                            <p>Phone <a href="tel:+92-666-888-0000">77766655</a></p>
                        </div><!-- /.topbar__info -->
                                ...
                                <div class="product-card">
                                    <div class="product-card__image">
                                        ...
                                        <div class="product-card__image-content">
                                            ...
                                            <a href="fertilizante.php"><i class="organik-icon-shopping-cart"></i></a>
                                        </div><!-- /.product-card__image-content -->
                                    </div><!-- /.product-card__image -->
                                    <div class="product-card__content">
                                        <div class="product-card__left">
                                            <h3><a href="fertilizante.php">Fertilizantes</a></h3>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product-card">
                                    <div class="product-card__image">
                                        ...
                                        <div class="product-card__image-content">
                                            <a href="#"><i class="organik-icon-heart"></i></a>
                                            <a href="fungicidas.php"><i class="organik-icon-shopping-cart"></i></a>
                                        </div><!-- /.product-card__image-content -->
                                    </div><!-- /.product-card__image -->
                                    <div class="product-card__content">
                                        <div class="product-card__left">
                                            <h3><a href="fungicidas.php">Fungicidas</a></h3>
                                            <p>     </p>
                                        </div><!-- /.product-card__left -->
                                        <div class="product-card__right">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product-card">
                                    <div class="product-card__image">
                                        ...
                                        <div class="product-card__image-content">
                                            <a href="#"><i class="organik-icon-heart"></i></a>
                                            <a href="herbecidas.php"><i class="organik-icon-shopping-cart"></i></a>
                                        </div><!-- /.product-card__image-content -->
                                    </div><!-- /.product-card__image -->
                                    <div class="product-card__content">
                                        <div class="product-card__left">
                                            <h3><a href="herbecidas.php">Herbicidas</a></h3>
                                            <p>   </p>
                                        </div><!-- /.product-card__left -->
                                        <div class="product-card__right">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product-card">
                                    <div class="product-card__image">
                                        ...
                                        <div class="product-card__image-content">
                                            <a href="#"><i class="organik-icon-heart"></i></a>
                                            <a href="insecticidas.php"><i class="organik-icon-shopping-cart"></i></a>
                                        </div><!-- /.product-card__image-content -->
                                    </div><!-- /.product-card__image -->
                                    <div class="product-card__content">
                                        <div class="product-card__left">
                                            <h3><a href="insecticidas.php">Insecticidas</a></h3>
                                            <p>   </p>
                                        </div><!-- /.product-card__left -->
                                        <div class="product-card__right">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product-card">
                                    <div class="product-card__image">
                                        ...
                                        <div class="product-card__image-content">
                                            <a href="#"><i class="organik-icon-heart"></i></a>
                                            <a href="semillas.php"><i class="organik-icon-shopping-cart"></i></a>
                                        </div><!-- /.product-card__image-content -->
                                    </div><!-- /.product-card__image -->
                                    <div class="product-card__content">
                                        <div class="product-card__left">
                                            <h3><a href="semillas.php">Semillas</a></h3>
                                            <p>    </p>
                                        </div><!-- /.product-card__left -->
                                        <div class="product-card__right">
                                            <i class="fa fa-star"></i>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-widget footer-widget__about-widget">
                            <a href="index.html" class="footer-widget__logo">
                                <img src="assets/images/logo_techic.jpg" alt="" width="105" height="43">
                            </a>
                            <p class="thm-text-dark">es una empresa dedicada a la venta y distribución de productos para la Agricultura.</p>
                        </div><!-- /.footer-widget -->
                        ...
                        <div class="footer-widget footer-widget__contact-widget">
                            ...
                            <ul class="list-unstyled footer-widget__contact">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:contacto@techic.com.bo">contacto@techic.com.bo</a>
                                </li>
                                <li>
                                    <i class="fa fa-map-marker-alt"></i>
                                    <a href="#">Av. Lanza #5896, Cochabamba - Bolivia</a>
                                </li>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2">
                        <div class="footer-widget footer-widget__links-widget">
                            <h3 class="footer-widget__title">Enlaces</h3><!-- /.footer-widget__title -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-widget">
                            <h3 class="footer-widget__title">Suscribete</h3><!-- /.footer-widget__title -->
            ...
            <div class="bottom-footer">
                <div class="container">
                    ...
                    <div class="inner-container text-center">
                        ...
                        <p class="thm-text-dark">© Copyright <span class="dynamic-year"></span> by Oasysonlineshop.com</p>
                    </div><!-- /.inner-container -->
                </div><!-- /.container -->
            </div><!-- /.bottom-footer -->
        </footer><!-- /.site-footer -->    
