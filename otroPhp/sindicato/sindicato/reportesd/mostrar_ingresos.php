...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='10'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='10' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='12'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='12' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='1'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='1' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='11'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='11' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='15'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='15' ";
...
?>
	...
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='9' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='9'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
?>
	...
	<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	 <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='3'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
...
?>
    ...
    <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l  where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and l.id_linea='1' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso ='2'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso, ti.monto_tipo_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and l.id_linea='1' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso ='2'  ";
  $res = consultaDB($sql);			
...
?>
    ...
    <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='6'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and  ti.id_tipo_ingreso='6'  ";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
     <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='5'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and  ti.id_tipo_ingreso='5'  ";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='17' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='17'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='18'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='18' ";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='19' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='19'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	  ...
	  <?php		
					...
					$numero = mysql_num_rows($propiet);			
						$propietario=mysql_fetch_array($propiet);						
			$sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='7'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$prueba=$nu[0];
...
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and ti.id_tipo_ingreso='7'  ";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and tt.id_tipo_transaccion='1'and t.estado='Activo' and l.id_linea='2' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
//$row[1]
...
<tr>
            <?php 
	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and l.id_linea='2' and m.id_movil=h.id_movil and tt.id_tipo_transaccion='4'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);

$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and l.id_linea='2' and  m.id_movil=h.id_movil and tt.id_tipo_transaccion='4'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
...
<tr>
            <?php 
	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='1'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='1'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
//$row[1]
$num=mysql_fetch_array($nume);
		echo "<td width='250'>";
...
<tr>
            <?php 
	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and l.id_linea='1' and m.id_movil=h.id_movil and tt.id_tipo_transaccion='4'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);

$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='4'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
$nume=mysql_fetch_array($nume);
...
<tr>
            <?php 
	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='2' and tt.id_tipo_transaccion='2'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and tt.id_tipo_transaccion='2'and t.estado='Activo' and l.id_linea='2' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
//$row[1]
$num=mysql_fetch_array($nume);
		echo "<td width='250'>";
...
<tr>
            <?php 
	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and l.id_linea='2' and m.id_movil=h.id_movil and tt.id_tipo_transaccion='3'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);

$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and l.id_linea='2' and  m.id_movil=h.id_movil and tt.id_tipo_transaccion='3'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
$nume=mysql_fetch_array($nume);
...
<tr>
            <?php 
	 $sql1=" select sum(total_hoja) as totalDia,  COUNT( numero_hoja ) AS numero from hoja_control h,movil m where h.id_movil=m.id_movil and m.id_linea='2' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql1=" select sum(tt.monto_transaccion)as aporte from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='2' and tt.id_tipo_transaccion='2'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num4=consultaDB($sql1);
$nu4=mysql_fetch_array($num4);
...
$sql1=" select sum(tt.monto_transaccion)as aporte from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='2' and tt.id_tipo_transaccion='3'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num2=consultaDB($sql1);
$nu2=mysql_fetch_array($num2);
...
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and h.total_hoja='15.00' and tt.id_tipo_transaccion='2'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
//$row[1]
$num=mysql_fetch_array($nume);
		echo "<td width='250'>";
...
<tr>
            <?php 
	 $sql1=" select sum(total_hoja) as totalDia,  COUNT( numero_hoja ) AS numero from hoja_control h,movil m where h.id_movil=m.id_movil and m.id_linea='1' and h.total_hoja='15.00' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
