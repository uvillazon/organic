...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='10'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='10' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='12'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='12' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='1'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='1' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='11'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='11' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='15'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='15' ";
...
?>
	...
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='9' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='9'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
?>
	...
	<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	 <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='3'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
...
?>
	...
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.tipo_ingreso LIKE 'Atraso asamblea'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.tipo_ingreso LIKE 'Atraso asamblea'  ";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
?>
    ...
    <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='6'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and  ti.id_tipo_ingreso='6'  ";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
     <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='5'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and  ti.id_tipo_ingreso='5'  ";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='17' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='17'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='18'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='18' ";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='19' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and ti.id_tipo_ingreso='19'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
