...
$deposito=$deposito+$monto1;
//fin
$total=($deposito - $prestamo);

						?>
  
    <td width="556">TOTAL DE INGRESOS DISPONIBLES:</td>
...
$total=($prueba2 );
    ...
    <td width="556">TOTAL DE INGRESOS POR VENTAS:</td>
    <td width="200" align="center" b></td>
	<td width="200" align="center" b><?=$total;?>[Bs]</td>
</table>
