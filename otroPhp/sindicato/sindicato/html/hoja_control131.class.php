...
return "<span style=\"position:absolute;background-color:pink;font-size:17px;font-family:Tahoma;font-weight:bold; background-color:orange;\">".$alerta."</span><br /><span>".$nombreCompleto."</span";
            ...
            if($nroHojasvencidas < 18 && $permitido=='normal')
		    {
             ...
             return "<span style=\"position:absolute;font-size:17px;font-family:Tahoma;font-weight:bold; background-color:pink;\">".$alerta2."</span><br /><span>".$nombreCompleto."</span";
            }
			else {if($nroHojasvencidas < 18 && $permitido=='permitido')
		    {
		     $alerta2 = 'Debe '.$nroHojasfaltantes.' hojas('.$mes2.') ,TIENE PERMISO ESPECIAL';
             return "<span style=\"position:absolute;font-size:17px;font-family:Tahoma;font-weight:bold; background-color:pink;\">".$alerta2."</span><br /><span>".$nombreCompleto."</span><input type=\"hidden\" name=\"id_movil\" value=\"".$nombreSocio['id_movil']."\">";
             }}
	    	 }
		 //echo $fechaIniciod;
		 }
