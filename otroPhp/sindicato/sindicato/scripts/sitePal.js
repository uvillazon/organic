...
function tt_Htm(tt, t_id, txt)
{
	...
	if(t_tit)
	{
		t_y += '<tr><td align="'+t_algn+'" class="TTTitle">'+t_tit+'</td></tr>';
	}
	t_y += '<tr><td><table class="Tooltip" border="0" cellpadding="'+t_padd+'" cellspacing="'+t_bw+'" width="100%">' +
		'<tr><td>';
