...
//---------------------------------------------------------------------------------------------------------
  ...
  this.textWidth = 470;                         // text field width (pixels)
  ...
  this.iconPath = "images/iconsrich";                      // path to icons
  this.bulletpoint = "images/bp.gif";                  // bullet point image (full path)
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.buildEditor = function() {
	...
	//document.writeln('<center><br></center>');
