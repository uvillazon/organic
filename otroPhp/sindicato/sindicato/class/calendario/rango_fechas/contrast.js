...
var gWeekDay=["Dom","Lun","Mar","Mie","Jue","Vie","Sab"];	// weekday caption from Sunday to Saturday
...
var gsOutOfRange="Lo siento, Usted no puede ir más allá del rango designado!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcCalBG="gray";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#999999";	// la fila de domingo lunes martes miercoles..................
var gsInnerTable="border=0 class='calendario'";	// HTML tag properties of the inner <table> tag, which holds all the calendar cells.
var gsOuterTable=NN4?"border=0":"border=0";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gcCellBG="#ffffff";	// para todas las celdas transparent!!!**************++++
...
var gcSatBG="#BEBEBE";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#BEBEBE";	// Sunday background color
...
var gcToggle="#0060BF";	// Color del cursor que se mueve por las celdas de los dias
...
var gAgendaMask=[-1,-1,gcCellBG,"red",-1,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
