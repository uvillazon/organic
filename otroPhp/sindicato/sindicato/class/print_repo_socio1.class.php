      ...
      <th>Pagado</th>
            ...
            foreach ($resultmovil1 as $key=>$value) {
              ...
              $tener = $query -> getRow("estado","tener","where id_linea = ".$value['id_linea']);
                ...
                $ahorros = $query->getRows("*","hoja_control h,movil m","where h.id_movil=m.id_movil and alquiler='0'  and m.id_linea='1' and h.id_movil = ".$value['id_movil']." and fecha_de_compra >= '".$fechaInicio."' and fecha_de_compra <= '".$fechaFin."'");
