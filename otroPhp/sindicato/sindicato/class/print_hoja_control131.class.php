...
$cantidadHojas=$_GET['cantidadHoja'];
		...
		if($movilSocio['id_linea']=="2"){
		//$detalleImporte = $query->getRows("transaccion, monto_transaccion","tener t, tipo_transaccion tt","where t.id_linea = ".$movilSocio['id_linea']." and t.id_tipo_transaccion = tt.id_tipo_transaccion and t.estado = 'Activo' AND tt.idaporte='1'");
