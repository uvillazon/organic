...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='12'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='12' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='11'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='11' ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='15'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='15' ";
...
?>
    ...
    <tr>
	        <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='6'  ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and m.id_linea='2' and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='6'  ";
...
$sql1="SELECT sum( i.monto_ingreso_dolar )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='18'  ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_dolar, i.monto_ingreso_dolar from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='18' ";
...
?>
  ...
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='19' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='19'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
?>
   ...
   <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	<tr>
            <?php 
	 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='20' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso1']."' and i.fecha_ingreso<='".$_GET['fechaingreso2']."' and i.id_tipo_ingreso='20'";
  $res = consultaDB($sql);			
  $r=mysql_fetch_array($res);
		echo "<td width='340'>";
...
<tr>
            <?php 
	 $sql1=" select sum(h.aporte)as aporte, COUNT( numero_hoja ) AS numero from linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='2' and  fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
...
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='5' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
...
<tr>
            <?php 
							 $sql1=" select sum(h.adeporte)as aporte, COUNT( numero_hoja ) AS numero from linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='2' and  fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
...
<tr>
            <?php 
	 $sql1=" select sum(h.aporte)as aporte, COUNT( numero_hoja ) AS numero from linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and  fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt, linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='5' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
...
<tr>
            <?php 
				 $sql1=" select sum(h.adeporte)as aporte, COUNT( numero_hoja ) AS numero from linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and  fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
...
//	 $sql1=" select sum(tt.monto_transaccion)as aporte, COUNT( numero_hoja ) AS numero from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='2' and h.total_hoja='15.00' and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
//$num=consultaDB($sql1);
	 $sql1=" select sum(h.asocio)as aporte, COUNT( numero_hoja ) AS numero from linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$num=consultaDB($sql1);
...
//$sql2=" select tt.monto_transaccion from tipo_transaccion tt, tener t,linea l, movil m, hoja_control h where tt.id_tipo_transaccion=t.id_tipo_transaccion and t.id_linea=l.id_linea and l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and h.total_hoja='15.00' and tt.id_tipo_transaccion='2'and t.estado='Activo'and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
//$nume=consultaDB($sql2);
$sql2=" select tt.monto_transaccion from tipo_transaccion tt,linea l, movil m, hoja_control h where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and tt.id_tipo_transaccion='6' and fecha_de_compra>='".$_GET['fechaingreso1']."' and fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
$nume=consultaDB($sql2);
//$row[1]
$num=mysql_fetch_array($nume);
		echo "<td width='250'>";
