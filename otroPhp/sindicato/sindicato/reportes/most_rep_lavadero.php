...
<table width="800" border="1" bordercolor="#000000" align="center" rules="cols">
    <tr>
	        <?php 
	  $sql1="SELECT SUM(montoingreso) as totalDiabs from ingresolubricante i where i.tipo='1' AND i.fecha>='".$_GET['fechaingreso5']."' and i.fecha<='".$_GET['fechaingreso6']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
 $total=$nu[0];	
/////////////////////HAYDEE
		echo "<td width='456'>";
		echo "INGRESOS LAVADERO";
        echo "</td>";
		echo "<td width='172' align='left'>";
		echo "";
        echo "</td>";
...
<table width="800" border="1" bordercolor="#000000" align="center" rules="cols">
    <tr>
	        <?php 
	  $sql1="SELECT SUM(monto_egreso) as totalDiabs from egreso_lubricante i where i.tipo='1' AND i.fecha>='".$_GET['fechaingreso5']."' and i.fecha<='".$_GET['fechaingreso6']."' ";				
$num=consultaDB($sql1);
$nu=mysql_fetch_array($num);
 $total=$nu[0];	
          echo "<td width='456'>";
		echo "EGRESOS LAVADERO";
        echo "</td>";
		echo "<td width='172' align='left'>";
		echo "";
        echo "</td>";
...
//$monto1=$nu['2'];
			...
			$sql2="SELECT SUM(monto_egreso) as totalDiabs from egreso_lubricante i where i.tipo='1' AND i.fecha>='".$_GET['fechaingreso5']."' and i.fecha<='".$_GET['fechaingreso6']."' ";				
$nume=consultaDB($sql2);
$nue=mysql_fetch_array($nume);
...
/////////////////////ojooooo
 $sql5="SELECT SUM(montoingreso) as totalDiabs from ingresolubricante i where i.tipo='1' AND i.fecha>='".$_GET['fechaingreso5']."' and i.fecha<='".$_GET['fechaingreso6']."' ";				
$num=consultaDB($sql5);
$nu=mysql_fetch_array($num);
 $monto1=$nu[0];	
...
//$monto1=$nu['2'];
			...
			$sql6="SELECT SUM(monto_egreso) as totalDiabs from egreso_lubricante i where i.tipo='1' AND i.fecha>='".$_GET['fechaingreso5']."' and i.fecha<='".$_GET['fechaingreso6']."' ";				
