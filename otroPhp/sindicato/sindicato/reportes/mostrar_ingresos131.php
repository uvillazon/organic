...
<?php		
					...
					$numero1 = mysql_num_rows($propiet1);			
						$propietario1=mysql_fetch_array($propiet1);	
			$sql1=" select sum(h.total_hoja) as totalDia, COUNT( h.numero_hoja ) AS numero from hoja_control h,linea l, movil m where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and h.fecha_de_compra>='".$_GET['fechaingreso1']."' and h.fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
...
$sql1=" select sum(h.aporte)as aporte, COUNT( numero_hoja ) AS numero from hoja_control h,linea l, movil m where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and h.fecha_de_compra>='".$_GET['fechaingreso1']."' and h.fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
...
$sql1=" select sum(h.adeporte)as aporte, COUNT( numero_hoja ) AS numero from hoja_control h,linea l, movil m where l.id_linea=m.id_linea and m.id_movil=h.id_movil and l.id_linea='1' and h.fecha_de_compra>='".$_GET['fechaingreso1']."' and h.fecha_de_compra<='".$_GET['fechaingreso2']."' ";				
