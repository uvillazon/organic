...
?>
	...
	<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
	 <tr>
	        <?php 
 $sql1="SELECT sum( i.monto_pago_ingreso )  AS monto_total, COUNT( i.id_tipo_ingreso ) AS numero from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='3' ";				
$num=consultaDB($sql1);
//$row[1]
$nu=mysql_fetch_array($num);
...
$sql="SELECT ti.tipo_ingreso, ti.monto_tipo_ingreso, i.monto_pago_ingreso from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='3'";
...
<table width="1000" border="1" bordercolor="#000000" align="center">
  ...
  <b class="titulo">INFORME DE RECIBOS <br>
  </b></td></tr></table>
  <table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='12'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='1'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='11'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
}else{ echo "(Cambio de nombre Linea 131)";}
	?>
	</td>
	</tr>
	</table>
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='15'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
}else{ echo "(Cuota venta de linea 131)";}
	?>
	</td>
	</tr>
	</table>
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='9'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='3'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
}else{ echo "(Falta asamblea ordinaria)";}
	?>
	</td>
	</tr>
	</table>
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='4'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
}else{ echo "(Atraso asamblea ordinaria)";}
	?>
	</td>
	</tr>
	</table>
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and l.id_linea='2'  and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='2'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
$r2= mysql_fetch_array($res2);
...
}else{ echo "(Permiso trabajo Linea 132)";}
	?>
	</td>
	</tr>
	</table>
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti, pertenece p, movil m, linea l where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.id_movil=p.id_movil and p.id_movil=m.id_movil and m.id_linea=l.id_linea and l.id_linea='1' and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='2'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
echo "(Permiso al trabajo Linea 131)";
 for ($i = 0; $i < $numero; $i++) {
?>
	-<?=$r2[0]?>
<?php
$r2= mysql_fetch_array($res2);
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='6'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
echo "(Atrasos al trabajo linea 131)";
 for ($i = 0; $i < $numero; $i++) {
?>
	-<?=$r2[0]?>
<?php
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='5'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
echo "(Atrasos al trabajo linea 132)";
 for ($i = 0; $i < $numero; $i++) {
?>
	-<?=$r2[0]?>
<?php
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='17'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='18'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='22'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='21'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='19'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
}else{ echo "Sanciones Linea 131/132";}
	?>
	</td>
	</tr>
	</table>
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='20'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
<table width="1000" border="1" bordercolor="#000000" align="center" rules="cols">
  ...
  <tr><td>
	...
	<?php
	$sql2="SELECT i.numero_registro from ingreso i, tipo_ingreso ti where i.id_tipo_ingreso = ti.id_tipo_ingreso and i.fecha_ingreso>='".$_GET['fechaingreso7']."' and i.fecha_ingreso<='".$_GET['fechaingreso8']."' and i.id_tipo_ingreso='7'";
  $res2= consultaDB($sql2);			
  $r2=mysql_fetch_array($res2);
  $numero = mysql_num_rows($res2);
//echo "$r2[0]";
...
echo "(Alquileres de Linea al sindicato)";
 for ($i = 0; $i < $numero; $i++) {
?>
	-<?=$r2[0]?>
<?php
