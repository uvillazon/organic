...
<div id="mceldaba">
  ...
  <tr>
    <td><br>
	    ...
	    <b></b>
              <form name="mform" method="get" action="mostrar_reporte_prestamo2.php">
        <strong>Opciones :</strong><br>
        <table width="100%" border="3">
          
          <tr>
            <td>Rango en fecha de Reporte: 
              <iframe width=132 height=142 name="gToday:contrast:agenda.js" id="gToday:contrast:agenda.js" src="../calendario/rango_fechas/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;"></iframe>  </td>
            
            <td width="25%" align="center"><input name="fechaingreso7" value="" size="12">
              <a onClick="if(self.gfPop)gfPop.fStartPop(document.mform.fechaingreso7,document.mform.fechaingreso8);return false;" HIDEFOCUS> </a><a onClick="if(self.gfPop)gfPop.fStartPop(document.mform.fechaingreso7,document.mform.fechaingreso7);return false;" hidefocus>
              <input name="inicio" type="submit" value=".." onClick="void(0);">
              </a></td>
            <td width="24%" align="center"><input name="fechaingreso8" value="" size="12">
              <a onClick="if(self.gfPop)gfPop.fEndPop(document.mform.fechaingreso7,document.mform.fechaingreso8);return false;" hidefocus>
              <input name="inicio2" type="button" value=".." onClick="void(0);">
              </a></td>
          </tr>
...
<b></b>
              <form name="mfor" method="get" action="mostrar_reporte_lavadero.php">
        <strong>Opciones :</strong><br>
        <table width="100%" border="3">
          
          <tr>
            <td>Rango en fecha de Reporte para lavadero: 
              <iframe width=132 height=142 name="gToday:contrast:agenda.js" id="gToday:contrast:agenda.js" src="../calendario/rango_fechas/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;"></iframe>  </td>
            
            <td width="25%" align="center"><input name="fechaingreso5" value="" size="12">
              <a onClick="if(self.gfPop)gfPop.fStartPop(document.mfor.fechaingreso5,document.mfor.fechaingreso6);return false;" HIDEFOCUS> </a><a onClick="if(self.gfPop)gfPop.fStartPop(document.mfor.fechaingreso5,document.mfor.fechaingreso6);return false;" hidefocus>
              <input name="inicio" type="submit" value=".." onClick="void(0);">
              </a></td>
            <td width="24%" align="center"><input name="fechaingreso6" value="" size="12">
              <a onClick="if(self.gfPop)gfPop.fEndPop(document.mfor.fechaingreso5,document.mfor.fechaingreso6);return false;" hidefocus>
              <input name="inicio2" type="button" value=".." onClick="void(0);">
              </a></td>
          </tr>
